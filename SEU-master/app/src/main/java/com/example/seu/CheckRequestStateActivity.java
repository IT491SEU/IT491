...
public class CheckRequestStateActivity extends AppCompatActivity {
    ...
    public void showCardData(View view) {
        ...
        if (donorIdentity.isEmpty()) {
            Toast.makeText(this, "أكتب رقم الهوية", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        firestore.collection("donors")
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        ...
                        if (size <= 0) {
                            Toast.makeText(CheckRequestStateActivity.this, "ﻻ يوجد طلب تبرع فى الوقت الحالي", Toast.LENGTH_SHORT).show();
                            return;
                        }
