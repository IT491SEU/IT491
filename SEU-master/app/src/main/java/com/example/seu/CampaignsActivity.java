...
public class CampaignsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setMessage("جاري إرفاق الخطاب");
        ...
        storage.child("letters").child(auth.getUid())
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(CampaignsActivity.this, "فشل إرفاق الخطاب", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void getLetterUrl() {
        storage.child("letters").child(auth.getUid())
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(CampaignsActivity.this, "تم إرفاق الخطاب بنجاح", Toast.LENGTH_LONG).show();
    ...
    public void register(View view) {
        ...
        if (letterUrl.isEmpty()) {
            Toast.makeText(this, "أرفق الخطاب", Toast.LENGTH_SHORT).show();
            return;
        }
